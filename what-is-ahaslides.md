...
**Can I import PowerPoint slides?** Yes. You can [import PPT, PPTX, or PDF files](importing-a-powerpoint-presentation-or-pdf-file.md) and insert interactive slides in between your existing content.
...
You can also [import PowerPoint presentations](importing-a-powerpoint-presentation-or-pdf-file.md) into AhaSlides and **insert interactive slides between your existing PowerPoint slides**, so you keep your content and add engagement at the same time.
...
| **PowerPoint** | Import PPT or PPTX files and insert interactive slides between your existing PowerPoint slides | [Importing a PowerPoint or PDF](importing-a-powerpoint-presentation-or-pdf-file.md) |
| **PDF** | Import a PDF as static slides and add interactive elements in between | [Importing a PowerPoint or PDF](importing-a-powerpoint-presentation-or-pdf-file.md) |
