...
<Frame>
  <iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/PeAS2yPtA_0" title="AhaSlides tutorial video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
</Frame>

## Try It Yourself

Explore a ready-made Categorise slide live — no account needed.

<Frame>
  <iframe className="w-full aspect-video rounded-xl" src="https://presenter.ahaslides.com/shared-template/1782226095960-ea9alcp4ex?hideAccessCode=true&hideText=true" title="Live AhaSlides Categorise template" allow="fullscreen" allowFullScreen></iframe>
</Frame>

<Card title="Use this template" icon="wand-magic-sparkles" href="https://presenter.ahaslides.com/demo/?refer=using-the-categorise-slide&sourcePresentation=9558419">
