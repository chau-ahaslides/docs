---
title: Using the AhaSlides App on Zoom
status: Published
...
plan_required: Free
portal_url: https://help.ahaslides.com/portal/en/kb/articles/using-the-ahaslides-app-on-zoom
related_articles:
  - KB-Teams-Add-in.md
...
**Run live polls, quizzes, word clouds, and more — without leaving your Zoom meeting.**

The AhaSlides app for Zoom lets you seamlessly integrate interactive presentations into your Zoom meetings and webinars. Participants can respond directly from within Zoom, with no need to visit a separate link or enter an access code.

---

## Requirements

- **Presenter and participants must use the Zoom Workplace or Zoom Webinar desktop app on PC or laptop.**
- The Zoom mobile app is not supported for this integration.
- Only the host (presenter) needs an AhaSlides account. Participants join as guests.
...
**Do participants need to install the AhaSlides app?**
No. Participants can accept the host's invitation or open AhaSlides from their Zoom Apps panel. They do not need a separate AhaSlides account.

**Do participants need an AhaSlides account?**
No. Only the host (presenter) requires an AhaSlides account. Participants join as guests.

**Can I use AhaSlides in Zoom without the Marketplace app?**
Yes. Open your presentation in a browser, go live, then use Zoom's screen sharing to present. Participants join via the access code as usual. This works but does not give participants the integrated in-Zoom experience.

**Is this available on Zoom mobile?**
No. The AhaSlides Zoom integration is only supported on the Zoom Workplace/Webinar desktop app (PC/laptop). Participants on mobile cannot use the in-Zoom panel and should join via the access code in a browser instead.
