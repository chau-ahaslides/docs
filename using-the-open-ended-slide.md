...
> Smart Grouping is only available when the Open-Ended slide receives **more than 10 submissions.** **This feature will only work once per session for each slide,** please **only group when everyone has submitted their answers.**

AhaSlides lets you smart group Open-Ended submissions, making it easier for presenters to spot patterns and understand audience responses quickly. Similar submissions are automatically grouped for better clarity.
