...
AhaSlides teams give you a shared workspace where members can view, edit, and present each other's work. The team owner can purchase licenses to give members full paid plan access, or run a free team where each member uses the free plan features.
